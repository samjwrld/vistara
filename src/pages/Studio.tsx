    ...
    <div className="pt-32 pb-12 w-full min-h-screen relative z-10 bg-[#fff4e8]">
      ...
      <section className="px-6 md:px-12 max-w-[1800px] mx-auto mb-32 md:mb-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <img src="/images/studio/s2.png" alt="Collaborative design zone" referrerPolicy="no-referrer" className="w-full h-full object-cover grayscale-[30%] hover:scale-[1.03] transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)]" />
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <img src="/images/studio/s3.png" alt="Material exploration" referrerPolicy="no-referrer" className="w-full h-full object-cover grayscale-[30%] hover:scale-[1.03] transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)]" />
          </motion.div>
        </div>
      </section>
