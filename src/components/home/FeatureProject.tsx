    ...
    return (
        <section className="relative z-10 w-full px-6 md:px-12 py-16 max-w-[1800px] mx-auto">
            <Link to="/projects/rainbow-courtyard-villa" className="block w-full relative h-[60vh] md:h-[80vh] overflow-hidden group cursor-pointer rounded-[2rem]">
                <img src="/images/homepage/h3.png" referrerPolicy="no-referrer" className="w-full h-full object-cover grayscale-[20%] group-hover:scale-[1.03] group-hover:grayscale-0 transition-all duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)]" alt="Courtyard House"/>
