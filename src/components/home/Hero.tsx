    ...
    <section className="relative min-h-screen flex items-center pt-32 pb-12 px-6 md:px-12 z-10 w-full max-w-[1800px] mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full pb-20">
        ...
        <div className="md:col-span-12 relative h-[45vh] sm:h-[55vh] md:h-[75vh] flex items-end">
          ...
          >
             <img src="/images/homepage/h1.png" alt="Modern Architecture Exterior" referrerPolicy="no-referrer" className="w-full h-full object-cover object-center grayscale-[30%] group-hover:scale-[1.03] group-hover:-translate-y-2 group-hover:grayscale-0 transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)]" />
          </motion.div>
          ...
          >
            <div className="w-full h-full overflow-hidden group">
              <img src="/images/homepage/h2.png" alt="Interior Detail" referrerPolicy="no-referrer" className="w-full h-full object-cover object-center group-hover:scale-[1.05] group-hover:-translate-y-1 transition-transform duration-[2s] ease-[cubic-bezier(0.16,1,0.3,1)]" />
            </div>
          </motion.div>
        </div>
      </div>
